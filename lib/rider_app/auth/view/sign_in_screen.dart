...
class SigninScreenRider  extends StatefulWidget {
  static const String route = '/SigninScreenRider';
  const SigninScreenRider({Key? key}) : super(key: key);

  @override
  State<SigninScreenRider> createState() => _SigninScreenRiderState();
}

class _SigninScreenRiderState extends State<SigninScreenRider>
        ...
        body: SizedBox(
          ...
          context, BottomNavBarRider.route, (route) => false);
                        ...
                        child: CustomButton(
                            ...
                            onPressed: () {
                              context.read<AuthRiderBloc>().add(AuthRiderEvent.login(
